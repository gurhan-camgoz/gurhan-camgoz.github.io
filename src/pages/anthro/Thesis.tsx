                    ...
                    <article className="max-w-3xl mx-auto">
                        ...
                        <header className="mb-12">
                            ...
                            <nav className="flex flex-wrap gap-4 text-sm font-mono">
                                ...
                                <a href="/master_theses/Masterthesis_Anthro_GurhanCamgoz.pdf" download className="text-amber-300 hover:text-amber-200 underline underline-offset-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 rounded">Download PDF</a>
                                <span className="text-stone-400">|</span>
