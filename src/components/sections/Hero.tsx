  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <motion.h1
          className="text-5xl md:text-7xl lg:text-8xl font-bold text-transparent mb-4 relative z-10"
        ...
        <motion.h2
          className="text-2xl md:text-3xl lg:text-5xl font-mono font-bold text-stone-800 mb-6"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
